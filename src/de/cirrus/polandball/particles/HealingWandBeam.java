...
public class HealingWandBeam extends Particle {
	...
	public HealingWandBeam(Mob from, Mob to) {
		this.from = from;
		this.to = to;
	...
	public void render(Bitmap b, int xp, int yp) {
		b.blendDraw(Art.i.particles[from.team == Team.soviet ? 0 : 1][3], xp - 4, yp - 4, 0x10101 * br);
	}
